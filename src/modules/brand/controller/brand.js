...
//     const defaultLocationId = '65f36abdc724e4188406c3b1';
//     // const locale = req.params.locale || 'en' // Get locale from request parameters (e.g., 'en' or 'ar')
//     const locale = req.params.locale && req.params.locale !== '' ? req.params.locale : 'en';
...
//     // If brand not found in both locations, return 404
//     if (!brand) {
//         return next(new Error(`Brand not found with ID ${req.params.brandId}`, { status: 404 }));
//     }


//     brand.name = brand.name[`${locale}`] || `coupons- ${locale}`
//     brand.description = brand.description[`${locale}`] || `coupons- ${locale}`
